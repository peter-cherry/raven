...
INSERT INTO work_items (
  ...
  '{
    "steps": [
      {"step": 1, "description": "Run database migration", "status": "in_progress"},
      {"step": 2, "description": "Create API routes", "status": "pending"},
  ...
  '{
    "files_involved": [
      "supabase/migrations/20250116_raven_agent.sql",
      "app/api/agent/",
